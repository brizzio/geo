class CustomControl extends L.Control {
    ...
    onAdd(map) {
        ...
        .custom-control .results-container {
            position: absolute;
            top: 40px;
            left: 10px;
            right: 10px;
        ...
        .custom-control .result-item {
            padding: 5px;
            cursor: pointer;
            display: flex;
            align-items: center;
        }
        .custom-control .result-item input[type="checkbox"] {
            flex: 1;
            min-width: 5%; /* 5% width for the checkbox */
            margin-right: 10px;
        }
        .custom-control .result-item label {
            flex: 19; /* 95% width for the label */
            margin-right: 10px;
        }
        .custom-control .result-item:hover {
