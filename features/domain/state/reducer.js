...
function normalizeProduct(item = {}) {
  ...
  return {
    ...
    package_type: normalizeText(item.package_type) || null,
    package_model: normalizeText(item.package_model) || null,
    package_material: normalizeText(item.package_material) || null,
    package_format: normalizeText(item.package_format) || null,
    package_dimensions_unit: normalizeText(item.package_dimensions_unit) || "cm",
    package_dimensions_height: normalizeProductNumber(item.package_dimensions_height),
    package_dimensions_width: normalizeProductNumber(item.package_dimensions_width),
    package_dimensions_depth: normalizeProductNumber(item.package_dimensions_depth),
    package_weight_unit: normalizeText(item.package_weight_unit) || null,
    package_gross_weight: normalizeProductNumber(item.package_gross_weight),
    package_net_weight: normalizeProductNumber(item.package_net_weight),
